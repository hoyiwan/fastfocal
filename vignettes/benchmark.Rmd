---
title: "Benchmarking Fastfocal vs terra::focal"
...
## What's faster — fastfocal or terra::focal?

Now you might be wondering — is `fastfocal()` actually faster?  
And how fast are we talking?

Let’s find out by pitting it against `terra::focal()` in a good old-fashioned benchmark battle.  
We’ll try it on a range of raster sizes and kernel radii, and chart out the differences in performance.

We’ll also skip the waiting (mostly) by loading precomputed results — but we’ll show you how to run the full benchmark if you’re feeling adventurous.
